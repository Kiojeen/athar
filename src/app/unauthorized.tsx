...
import { ShieldAlert, ArrowLeft, Home, UserRound } from "lucide-react";
      ...
      <Card className="border-border/60 relative z-10 w-full max-w-md text-center shadow-lg">
        ...
        <CardContent className="space-y-3 pb-8">
          <p className="text-muted-foreground text-sm leading-relaxed">
            عذراً، لا تملك الصلاحيات الكافية للوصول إلى هذه الصفحة. يرجى التأكد من تسجيل الدخول بالحساب المناسب أو التواصل مع الإدارة إذا كنت تعتقد أن هذا الخطأ غير صحيح.
          </p>
          <div className="bg-muted/40 text-muted-foreground inline-block rounded-md px-2.5 py-1 font-mono text-xs">
            خطأ 403: Access Denied
          </div>
        </CardContent>

        <CardFooter className="flex flex-col gap-2.5 border-t border-border/40 pt-6">
